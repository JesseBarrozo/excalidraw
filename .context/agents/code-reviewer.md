...
Review for behavioral regressions, immutable element/version rules, undo/redo correctness, collaboration side effects, accessibility, and browser compatibility. Confirm tests exercise observable behavior and that TypeScript, ESLint, and Prettier pass on the touched scope.
