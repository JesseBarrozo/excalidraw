...
Document public package behavior in `dev-docs` or nearby READMEs and internal architecture in `.context/docs`. Use real paths and commands, keep examples compatible with exported APIs, and avoid duplicating implementation details that quickly drift.
