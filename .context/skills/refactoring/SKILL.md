...
Preserve element identity/version rules and package exports. Move pure behavior into small modules with adjacent tests, keep `App.tsx` orchestration explicit, and validate each stage with focused Vitest plus typecheck.
