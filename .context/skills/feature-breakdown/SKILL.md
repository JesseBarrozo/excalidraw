...
Break work into event/data-flow discovery, element/scene implementation, history and collaboration behavior, focused tests, and repository checks. Call out desktop/mobile, frames, clipboard fallbacks, and long-scene performance where applicable.
