...
Compare the PR against nearby editor tests and package boundaries. Check public API compatibility, serialized elements, input semantics, history, collaboration, accessibility, and whether generated/runtime files were accidentally included.
