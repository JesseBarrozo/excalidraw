...
Review immutable element updates, fractional ordering, Store capture mode, undo/redo, collaboration emissions, browser compatibility, and frame membership. Require targeted Vitest, TypeScript, ESLint, and formatting evidence.
