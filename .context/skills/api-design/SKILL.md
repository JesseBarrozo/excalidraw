...
Treat the exported React props, imperative API in `packages/excalidraw/types.ts`, serialized element schema, and package entry points as APIs. Prefer additive changes, document capture/history semantics, and verify examples against `packages/excalidraw/index.tsx`.
