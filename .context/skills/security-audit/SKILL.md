...
Audit clipboard MIME parsing, imports, SVG/images, embeddable URLs, share links, collaboration payloads, and storage adapters. Reuse the repository's sanitizers and never weaken same-frame browser permission checks.
