...
Use concrete links to `packages/excalidraw`, `packages/element`, `packages/common`, `excalidraw-app`, and `dev-docs`. Commands should use `corepack yarn`; public API documentation must match exported types and entry points.
