...
Use a concise imperative subject describing the user-visible or maintenance outcome. Keep generated `.context/runtime`, caches, and local plans out of commits; include durable `.context` docs only when intentionally initialized or updated.
