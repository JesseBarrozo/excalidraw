...
- `crowdin.yml/` — explain what lives here and when agents should edit it.
- `dev-docs/` — explain what lives here and when agents should edit it.
...
- `excalidraw-app/` — explain what lives here and when agents should edit it.
